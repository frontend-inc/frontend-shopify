...
var useCustomers = function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadingWrapper(function () {
                        return shopifyClient.findCustomer(customerAccessToken);
                    })];
                case 1:
                    resp = _a.sent();
    ...
    var createCustomer = function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, loadingWrapper(function () {
                            return shopifyClient.createCustomer({
                                firstName: firstName,
                                lastName: lastName,
                                email: email,
                                password: password,
    ...
    var updateCustomer = function (customerAccessToken, customer) { return __awaiter(void 0, void 0, void 0, function () {
        var resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadingWrapper(function () {
                        return shopifyClient.updateCustomer(customerAccessToken, customer);
                    })];
                case 1:
                    resp = _a.sent();
                    setCustomer(resp === null || resp === void 0 ? void 0 : resp.data);
