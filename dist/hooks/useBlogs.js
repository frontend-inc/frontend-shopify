            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, loadingWrapper(function () {
                            return shopifyClient.findBlog(handle, perPage);
                        })];
                    case 1:
                        response = _b.sent();
                        setBlog(response === null || response === void 0 ? void 0 : response.data);
                        setArticles((_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.articles);
    ...
    var findBlogs = function (perPage) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadingWrapper(function () {
                            return shopifyClient.findBlogs(perPage);
                        })];
                    case 1:
                        response = _a.sent();
                        setBlogs(response === null || response === void 0 ? void 0 : response.data);
                        return [2 /*return*/, response === null || response === void 0 ? void 0 : response.data];
                }
            });
        });
