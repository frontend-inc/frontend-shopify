            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadingWrapper(function () {
                            return shopifyClient.findArticle(blogHandle, articleHandle, perPage);
                        })];
                    case 1:
                        response = _a.sent();
                        setArticle(response === null || response === void 0 ? void 0 : response.data);
    ...
    var fetchArticles = function (perPage) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadingWrapper(function () {
                            return shopifyClient.findArticles(perPage);
                        })];
                    case 1:
                        response = _a.sent();
                        setArticles(response === null || response === void 0 ? void 0 : response.data);
                        return [2 /*return*/, response === null || response === void 0 ? void 0 : response.data];
                }
            });
        });
